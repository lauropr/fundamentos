		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#z99fundamentos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"z99fundamentos-display": {
								"semanticObject": "z99fundamentos",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=z99.fundamentos",
									"url": sap.ui.require.toUrl("z99/fundamentos")
								}
							}
						}
					}
